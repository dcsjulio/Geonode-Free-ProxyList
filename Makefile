# This Makefile is for the Geonode::Free::ProxyList extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Geonode/Free/ProxyList.pm]
...
#     NAME => q[Geonode::Free::ProxyList]
#     PREREQ_PM => { Test::More=>q[0] }
#     TEST_REQUIRES => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Geonode/Free/ProxyList.pm]
#     clean => { FILES=>q[Geonode-Free-ProxyList-*] }
...
NAME_SYM = Geonode_Free_ProxyList
VERSION = 0.0.4
...
PERL_ARCHLIBDEP = C:\Perl\perl\lib
LIBPERL_A = libperl.a
...
PERL_INCDEP = C:\Perl\perl\lib\CORE
...
MAKE = gmake
FULLEXT = Geonode\Free\ProxyList
BASEEXT = ProxyList
PARENT_NAME = Geonode::Free
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)\Geonode\Free
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Geonode\Free
...
TO_INST_PM = lib/Geonode/Free/Proxy.pm \
...
DISTNAME = Geonode-Free-ProxyList
DISTVNAME = Geonode-Free-ProxyList-0.0.4
...
ProxyList.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Geonode::Free::ProxyList\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Get Free Geonode Proxies by using some filters'" >> META_new.yml
	$(NOECHO) $(ECHO) author: >> META_new.yml
	$(NOECHO) $(ECHO) "  - 'Julio de Castro <julio.dcs@gmail.com>'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Geonode-Free-ProxyList" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Get Free Geonode Proxies by using some filters\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"Julio de Castro ^<julio.dcs^@gmail.com^>\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Geonode-Free-ProxyList\"," >> META_new.json
...
MAP_TARGET    = perl
FULLPERL      = "C:\Perl\perl\bin\perl.exe"
MAP_PERLINC   = "-Iblib\arch" "-Iblib\lib" "-IC:\Perl\perl\lib" "-IC:\Perl\perl\lib"
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Geonode-Free-ProxyList\" VERSION=\"0.0.4\">" > Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>Get Free Geonode Proxies by using some filters</ABSTRACT>" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Julio de Castro &lt;julio.dcs@gmail.com&gt;</AUTHOR>" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "        <PERLCORE VERSION=\"5,010,0,0\" />" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.32\" />" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> Geonode-Free-ProxyList.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> Geonode-Free-ProxyList.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Geonode/Free/Proxy.pm blib\lib\Geonode\Free\Proxy.pm \
	  lib/Geonode/Free/ProxyList.pm blib\lib\Geonode\Free\ProxyList.pm 
